...
MySQL - 5.6.25 : Database - db_pernikahan
*********************************************************************
*/
...
insert  into `tb_statusnikah`(`idstatus`,`namastatus`) values (1,'Belum Menikah'),(2,'Menikah'),(3,'Janda'),(4,'Duda');
...
insert  into `tb_warga`(`nik`,`namalengkap`,`alamat`,`jk`,`statusnikah`,`statuslain`,`foto`) values ('1111','111',NULL,'L','M',NULL,NULL);
